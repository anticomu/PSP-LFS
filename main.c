...
CarData car_db[] = {
    {"XF GTI", 0.05f, 0xFF0000FF},
    {"XR GT",  0.08f, 0xFF00FF00},
    {"RB4 GT", 0.12f, 0xFFFF0000}
};

typedef struct { float x, z, angle, speed; int car_idx; } Player;
...
int main() {
    ...
    while(1) {
        ...
        if (current_state == STATE_MENU) {
            ...
            sceGumTranslate(&car_pos); sceGumRotateY(player.angle);
